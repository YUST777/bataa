...
/**
 * 3D Isometric stacked code blocks / tokens for "INTERACTIVE / LEARN"
 */
...
/**
 * Animated Bataa Mascot Character Illustration with video for "PRACTICE"
 */
...
/**
 * 3D Isometric Diploma Certificate & Gold Medal for "BUILD"
 */
  ...
  return (
    ...
    >
      <defs>
        ...
        <filter id="shadowCert" x="-10%" y="-10%" width="120%" height="130%">
          <feDropShadow dx="0" dy="6" stdDeviation="6" floodColor="#140803" floodOpacity="0.4" />
        </filter>
      </defs>
